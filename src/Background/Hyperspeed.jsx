  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Use a custom timer instead of deprecated THREE.Clock
        this.elapsedTime = 0;
        this.lastTime = null;
        this.assets = {};
        this.disposed = false;
      ...
      initPasses() {
        // Simplified postprocessing: only a basic RenderPass to avoid
        // GPU/driver-specific issues from advanced passes (bloom/SMAA).
        try {
          ...
          console.error('Failed to initialize postprocessing passes, falling back to basic render.', error);
          this.composer = null;
        }
      }
    ...
    try {
      ...
      console.error('Hyperspeed: WebGL context could not be created, disabling effect.', error);
      return;
    }
