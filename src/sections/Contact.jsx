  ...
  return (
    <section id="contact" className="py-32 px-6 relative">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-secondary/60 mt-8 mb-12 text-lg max-w-xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <motion.a
            ...
            className="px-10 py-4 bg-primary text-white font-bold rounded-xl transition-all"
          >
            Send Message
          </motion.a>
          ...
          <motion.a
            ...
            className="px-10 py-4 glass text-white font-bold rounded-xl border border-white/10"
          >
            LinkedIn
          </motion.a>
        </div>

        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-secondary/40 font-mono text-xs gap-4">
