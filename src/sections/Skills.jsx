...
const AnalogClock = () => {
  ...
  return (
    <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-72 md:h-72 flex items-center justify-center [--clock-radius:90px] sm:[--clock-radius:110px] md:[--clock-radius:140px]">
      ...
      <div className="relative w-full h-full rounded-full 
        ...
        {[...Array(12)].map((_, i) => {
          ...
          return (
            <div
              key={num}
              className="absolute text-[10px] sm:text-xs text-white/70 font-mono"
              style={{
        ...
        {/* Hour Hand */}
        <div
          className="absolute w-[4px] h-[48px] sm:h-[60px] md:h-[72px] bg-white rounded-full origin-bottom z-30"
          style={{
        ...
        {/* Minute Hand */}
        <div
          className="absolute w-[2.5px] h-[66px] sm:h-[85px] md:h-[104px] bg-cyan-400 rounded-full origin-bottom z-20"
          style={{
        ...
        {/* Second Hand */}
        <div
          className="absolute w-[1.5px] h-[78px] sm:h-[100px] md:h-[124px] bg-red-500 rounded-full origin-bottom z-40"
          style={{
        ...
        {/* Digital Time */}
        <div className="absolute bottom-5 sm:bottom-6 text-[10px] font-mono text-cyan-300 tracking-widest">
...
const SkillNode = ({ id, title, skills }) => (
  <motion.div
    ...
    className="glass w-full max-w-[320px] md:max-w-[200px] p-4 rounded-2xl border border-white/5 hover:border-cyan-400/30 transition-all"
  >
...
export default function Skills() {
  return (
    <section
      className="min-h-[90vh] bg-[#020617] text-white py-16 px-4 sm:px-6 relative overflow-hidden"
      id="skills"
    >
      {/* Background Grid */}
      <div
      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center relative z-10">
        ...
        {/* Layout */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 sm:gap-12 md:gap-24">
        ...
        {/* Footer */}
        <div className="mt-16 w-full flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 border-t border-white/10 pt-6 font-mono text-[10px] text-white/30 uppercase tracking-widest">
